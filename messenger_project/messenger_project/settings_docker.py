...
SECRET_KEY = 'django-insecure-uezcov+d$&3bj&zqsur^b^vko-2e+9#bv6r36z&s=30mink1b)'
...
# або
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'messenger/static')]
...
# Вкажіть шлях, де будуть зберігатися медіа-файли
